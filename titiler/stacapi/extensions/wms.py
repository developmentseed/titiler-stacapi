...
from titiler.extensions.wms import DEFAULT_TEMPLATES, WMSMediaType
from titiler.stacapi.factory import (
    OGCWMTSFactory,
    get_dependency_params,
    get_layer_from_collections,
)
from titiler.stacapi.models import LayerDict
...
class wmsExtension(FactoryExtension):
    ...
    def register(self, factory: OGCWMTSFactory):  # noqa: C901
        ...
        def wms(  # noqa: C901
            request: Request,
            api_params=Depends(factory.path_dependency),
            ...
            pixel_selection_dependency=Depends(factory.pixel_selection_dependency),
            ...
            # Version is mandatory is mandatory in the specification but we default to 1.3.0
            ...
            layers = get_layer_from_collections(
                ...
                supported_tms=factory.supported_tms,
            )
            ...
            def get_map_data(  # noqa: C901
                ...
                with factory.backend(
                    ...
                    layer_params = get_dependency_params(
                        dependency=factory.layer_dependency,
                        query_params=query_params,
                    )

                    # pixel_selection = get_dependency_params(
                    #     dependency=pixel_selection_dependency,
                    #     query_params=query_params,
                    # )
                    ...
                    #     pixel_selection=OverlayMethod(),
                    # )
                    return _reader(), format, transparent
            ...
            if request_type.lower() == "getcapabilities":
                ...
                for lay in layers:
                    ...
                    layers_dict[lay]["bounds"] = layers[lay]["bbox"]
                    layers_dict[lay]["bounds_wgs84"] = layers[lay]["bbox"]
                ...
                image, format, transparent = get_map_data(
                    req, req_keys, request_type, layer
                )
                ...
                image, _, _ = get_map_data(req, req_keys, request_type, layer)
                i = int(req["i"])
                j = int(req["j"])
